...
<!--Load jQuery first, BootStrap uses it in their javascript files
    Then we can load up AngularJS and finally load up the BootStrap CSS files
-->
...
<script src="/Hospital-Scheduler/dist/oauth.min.js"></script>
